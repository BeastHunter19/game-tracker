    ...
    <header>
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark shadow">
            <div class="d-flex justify-content-between container-fluid">
                ...
                <!-- Navigation -->
                <div class="collapse navbar-collapse multi-collapse w-auto" id="navigation-panel">
                    <ul class="navbar-nav nav-pills me-auto mb-2 mb-lg-0">
                        <li v-for="(page, index) in appPages" :key="index" class="nav-item mx-2">
                            <RouterLink class="nav-link" active-class="active shadow" :to="page.path">
                                {{ page.name }}
                            </RouterLink>
                        </li>
                    </ul>
                ...
                <!-- Login buttons -->
                <span class="collapse navbar-collapse multi-collapse" id="login-panel">
