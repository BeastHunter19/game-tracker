        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark shadow">
            <div class="container-fluid text-center">
                <div class="row flex-grow-1">
                    <!-- Main section -->
                    <div class="collapse navbar-collapse multi-collapse col-lg-4" id="navigation-panel">
                        <!-- Brand -->
                        <a class="navbar-brand ms-3" href="#">Game Tracker</a>

                        <!-- Navigation -->
                        <ul class="navbar-nav nav-pills me-auto mb-2 mb-lg-0">
                            <li v-for="(page, index) in appPages" :key="index" class="nav-item mx-2">
                                <RouterLink class="nav-link" active-class="active aria-current shadow" :to="page.path">
                                    {{ page.name }}
                                </RouterLink>
                            </li>
                        </ul>
                    ...
                    <!-- Login buttons -->
                    <div class="collapse navbar-collapse multi-collapse col-lg-4 justify-content-end" id="login-panel">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target=".multi-collapse"
                    aria-controls="navigation-panel login-panel" aria-expanded="false" aria-label="Toggle navigation">
